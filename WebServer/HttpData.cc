...
void HttpData::handleRead()
{
    ...
    do
    {
        ...
        {
            //有请求出现但读不到数据，可能是Request Aborted, 或者来自
            //网络的数据没有到达等原因，最有可能是对端已经关闭，统一按对端关闭处理
        ...
        if(state_ == STATE_RECV_BODY)
        {
            ...
            {
                error_ = true;
                handleError(fd_, 400, "Bad Request: Lack of arguement (Content-length)");
                break;
            }
